...
author: desain
image: https://owlbear-behaviors.nicholassdesai.workers.dev/docs/assets/hero.png
icon: https://owlbear-behaviors.nicholassdesai.workers.dev/logo-bg.svg
learn-more: https://github.com/desain/owlbear-behaviors
tags:
    - automation
manifest: https://owlbear-behaviors.nicholassdesai.workers.dev/manifest.json
---

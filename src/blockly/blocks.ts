...
export const BLOCK_CHANGE_SIZE = {
  ...
  tooltip: "Change the size of this token by a percentage of its original size",
  helpUrl: "",
...
export const BLOCK_SOUND_PLAY = {
  style: "sound_blocks",
  type: "sound_play",
  tooltip: "Start playing a sound, and continue immediately to the next block.",
  helpUrl: "",
...
export const BLOCK_EXTENSION_GRIMOIRE_HP_CHANGE = {
  ...
  tooltip: "Runs the blocks below when this token's HP changes in the Game Master's Grimoire extension",
  helpUrl: "",
